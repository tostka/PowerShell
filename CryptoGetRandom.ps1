#*======v Function Get-CrytpoRandom SET () v======
<#requires -Version 2.0#>

#*------v Function Get-CryptoRandom v------
function Get-CryptoRandom {
    ...
    Website:	https://gallery.technet.microsoft.com/scriptcenter/New-version-of-Get-Random-d868af29#content
    Change Log
    * 1:53 PM 11/20/2015 reformatted 
    * posted vers:  2/11/2014
    ...
    BEGIN {
        ...
        } #*------^ END Function GetRandom($Min, $Max) ^------#  ; 

        #*------v Function GetRandomDouble() v------
        ...
        } #*------^ END Function ConvertToNumber($Value) ^------
...
} #*======^ END Function Get-CrytpoRandom SET () ^======
